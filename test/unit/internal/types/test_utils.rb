...
describe Voltaria::Internal::Types::Utils do
  Utils = Voltaria::Internal::Types::Utils

  module TestUtils
    class M < Voltaria::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Voltaria::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Voltaria::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Voltaria::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Voltaria::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Voltaria::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Voltaria::Internal::Types::Array[String]
      ModelArray = -> { Voltaria::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Voltaria::Internal::Types::Array[TestUtils::U] }

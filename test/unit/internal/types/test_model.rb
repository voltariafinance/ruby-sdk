...
describe Voltaria::Internal::Types::Model do
  ...
  class ExampleModel < Voltaria::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Voltaria::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Voltaria::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Voltaria::Internal::Types::Model

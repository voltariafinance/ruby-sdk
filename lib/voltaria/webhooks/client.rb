...
module Voltaria
  module Webhooks
    class Client
      ...
      # @option params [Voltaria::Types::WebhookEventTypeEnum, nil] :event_type
      #
      # @return [Voltaria::Types::PaginatedResponseWebhookSubscriptionResponse]
      ...
      #
      # @param request_options [Hash]
      # @param params [Voltaria::Webhooks::Types::WebhookCreatePayload]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Voltaria::Types::WebhookSubscriptionResponse]
      ...
      #
      # @param request_options [Hash]
      # @param params [Voltaria::Webhooks::Types::WebhookUpdatePayload]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      # @option params [Integer, nil] :page_size
      #
      # @return [Voltaria::Types::PaginatedResponseWebhookLogResponse]

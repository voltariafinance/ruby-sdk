...
module Voltaria
  module Types
    class PaginatedResponseWaterfallResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::WaterfallResponse] }, optional: false, nullable: false

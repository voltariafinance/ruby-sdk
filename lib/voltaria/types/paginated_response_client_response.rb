...
module Voltaria
  module Types
    class PaginatedResponseClientResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::ClientResponse] }, optional: false, nullable: false

...
module Voltaria
  module Types
    class PaginatedResponseCollectionActionResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::CollectionActionResponse] }, optional: false, nullable: false

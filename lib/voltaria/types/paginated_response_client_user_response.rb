...
module Voltaria
  module Types
    class PaginatedResponseClientUserResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::ClientUserResponse] }, optional: false, nullable: false

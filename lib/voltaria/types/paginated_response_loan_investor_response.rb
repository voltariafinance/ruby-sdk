...
module Voltaria
  module Types
    class PaginatedResponseLoanInvestorResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::LoanInvestorResponse] }, optional: false, nullable: false

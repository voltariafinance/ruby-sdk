...
module Voltaria
  module Types
    class PaginatedResponseLimitRequestResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::LimitRequestResponse] }, optional: false, nullable: false

...
module Voltaria
  module Types
    class PaginatedResponseWebhookSubscriptionResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::WebhookSubscriptionResponse] }, optional: false, nullable: false

...
module Voltaria
  module Types
    class PaginatedResponseChecklistSummaryPartnerResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::ChecklistSummaryPartnerResponse] }, optional: false, nullable: false

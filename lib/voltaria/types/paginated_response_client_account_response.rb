...
module Voltaria
  module Types
    class PaginatedResponseClientAccountResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::ClientAccountResponse] }, optional: false, nullable: false

...
module Voltaria
  module Types
    class PaginatedResponseClientInvestorResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::ClientInvestorResponse] }, optional: false, nullable: false

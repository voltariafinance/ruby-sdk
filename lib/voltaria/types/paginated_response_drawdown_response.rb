...
module Voltaria
  module Types
    class PaginatedResponseDrawdownResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::DrawdownResponse] }, optional: false, nullable: false

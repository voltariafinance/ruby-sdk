...
module Voltaria
  module Types
    class PaginatedResponseWaiverResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::WaiverResponse] }, optional: false, nullable: false

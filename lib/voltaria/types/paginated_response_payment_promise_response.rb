...
module Voltaria
  module Types
    class PaginatedResponsePaymentPromiseResponse < Internal::Types::Model
      field :items, -> { Internal::Types::Array[Voltaria::Types::PaymentPromiseResponse] }, optional: false, nullable: false

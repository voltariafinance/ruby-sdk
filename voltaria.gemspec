...
require_relative "lib/voltaria/version"
...
Gem::Specification.new do |spec|
  spec.name = "voltaria_sdk"
  spec.authors = ["Voltaria"]
  spec.version = Voltaria::VERSION
  spec.summary = "Ruby client library for the Voltaria API"
  spec.description = "The Voltaria Ruby library provides convenient access to the Voltaria API from Ruby."
